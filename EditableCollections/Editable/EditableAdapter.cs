...
namespace EditableCollections.Editable
{
       ...
       IEditable
    {
        ...
        {
            var property = WrappedInstance.GetType().GetProperty(propertyName);
            if (property != null)
            {
            ...
            throw new Exception(
                $"{GetType().Name}.ReadUncommitted was called for property '{propertyName}' which could not be found on the object '{WrappedInstance}'");
        }
